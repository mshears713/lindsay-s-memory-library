...
import angryLindsay from "@/assets/angry-lindsay.jpg";
...
const RestrictedArea = () => {
  ...
  return (
    <PageContainer title="Restricted Area" subtitle="You probably shouldn't be here">
      ...
      {/* Clearance Level + Forbidden Machine */}
      <motion.section
      ...
      {/* Forbidden Machine — now right below clearance level */}
      <motion.section
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-4">
            <motion.div
              ...
              className="w-32 h-32 md:w-40 md:h-40 rounded-xl overflow-hidden shadow-lg select-none border-2 border-chapter-coral/20"
            >
              <img src={angryLindsay} alt="Lindsay's Computer" className="w-full h-full object-cover object-top" />
            </motion.div>
